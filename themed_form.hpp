...
public:
	...
	bool dark_theme() const { return use_dark_mode; }
	void system_theme(bool enable);
	bool system_theme() const { return use_system_setting; }
	bool system_supports_darkmode() const { return dark_mode_supported; }
